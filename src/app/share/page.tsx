      ...
      <div className="wrap" style={{ paddingTop: 60, paddingBottom: 80 }}>
        ...
        >
          ...
          <p style={{ fontSize: 14, color: "#FFFFFF", fontWeight: 500 }}>
            Share it with your print shop — it can only be opened once
          </p>
        </div>
        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex", gap: 8 }}>
              ...
              <button
                ...
                style={{
                  padding: "10px 18px",
                  background: copied ? "var(--success-bg)" : "var(--yellow)",
                  border: `2px solid ${copied ? "var(--success-border)" : "var(--ink)"}`,
                  borderRadius: 8,
                  fontWeight: 700,
                  fontSize: 13,
                  cursor: "pointer",
                  boxShadow: "var(--shadow-xs)",
                  whiteSpace: "nowrap",
                  color: copied ? "var(--success-text)" : "var(--ink)",
                  flexShrink: 0,
          ...
          >
            ...
            >
              QR Code — show this to the print shop
            </div>
            <div
              style={{
                display: "inline-block",
            ...
            >
              {qrDataUrl ? (
                <img
                  src={qrDataUrl}
                  alt="QR Code for secure document link"
                  width={240}
                  height={240}
                  style={{ display: "block" }}
                />
          ...
          >
            ...
            <div
              style={{
                ...
                border: "2px solid var(--amber-banner-border)",
                borderRadius: 10,
                padding: "12px 16px",
                display: "flex",
                alignItems: "center",
