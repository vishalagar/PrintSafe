...
export default function UploadPage() {
  ...
  const handleFile = useCallback((f: File) => {
    ...
    if (!ALLOWED_MIMES.includes(effectiveMime)) {
      ...
      setError(
        `Unsupported file type${detected}. Please upload a PDF, JPG, PNG, or HEIC.`,
      );
      return;
    }
    setFile(f);
    capture("FileSelected", {
      fileType: mimeToFileType(effectiveMime),
      fileSizeBucket: sizeToFileSizeBucket(f.size),
    });
  }, []);
  ...
  return (
    <div style={{ position: "relative", zIndex: 1, minHeight: "100vh" }}>
      ...
      <div
        className="wrap"
        style={{ paddingTop: 80, paddingBottom: 60, textAlign: "center" }}
      >
        <div
          style={{
            display: "inline-flex",
      ...
      <div className="wrap" style={{ paddingBottom: 80 }}>
        ...
        >
          ...
          <div
            ...
            style={{
              border: `2px ${isDragging ? "solid" : "dashed"} ${isDragging ? "var(--ink)" : "var(--drop-border)"}`,
              borderRadius: 12,
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                ...
                <div style={{ flex: 1, textAlign: "left", minWidth: 0 }}>
                  ...
                  >
                    ...
                    >
                      {MIME_LABEL[getEffectiveMime(file)] ?? "FILE"}
                    </span>
                  </p>
                </div>
                <button
            ...
            {EXPIRY_OPTIONS.map((opt) => (
              <button
                ...
                style={{
                  ...
                  border: "2px solid var(--ink)",
                  background:
                    ttl === opt.ttl ? "var(--yellow)" : "var(--surface)",
                  color: ttl === opt.ttl ? "var(--ink)" : "var(--text-dim)",
                  fontSize: 13,
                  fontWeight: 700,
                  cursor: "pointer",
                  boxShadow: "var(--shadow-sm)",
