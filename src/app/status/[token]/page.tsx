...
export default function StatusPage() {
  ...
  async function fetchStatus() {
    try {
      ...
      if (
        (json.status === "deleted" || json.status === "expired") &&
        pollRef.current
      ) {
  ...
  async function handleDelete() {
    const deleteToken =
      localStorage.getItem(`ps_del_${token}`) ??
      sessionStorage.getItem(`ps_del_${token}`);
    if (!deleteToken) {
      setDeleteError(
        "Delete token not found. You can only delete from the browser where you originally uploaded the document.",
      );
      return;
    }
    setIsDeleting(true);
  ...
  > = {
    pending: {
      label: "Pending — Not yet opened",
      bg: "var(--amber-banner-bg)",
      border: "var(--amber-banner-border)",
      text: "var(--amber-banner-text)",
      dot: "var(--amber)",
    },
    viewed: {
      label: "Viewed — Document opened",
      bg: "var(--success-bg)",
      border: "var(--success-border)",
      text: "var(--success-text)",
      dot: "var(--success-border)",
    },
    deleted: {
      label: "Deleted — Permanently destroyed",
      bg: "var(--red-dim)",
      border: "var(--red)",
      text: "var(--red)",
      dot: "var(--red)",
    ...
    expired: {
      label: "Expired — Never opened",
      bg: "var(--expired-bg)",
      border: "var(--expired-border)",
      text: "var(--expired-text)",
      dot: "var(--expired-border)",
    },
  };
    ...
    <div style={{ position: "relative", zIndex: 1, minHeight: "100vh" }}>
      ...
      <div className="wrap" style={{ paddingTop: 48, paddingBottom: 80 }}>
        <div style={{ maxWidth: 560, margin: "0 auto" }}>
          {/* Header */}
          <div
            style={{ marginBottom: 28, animation: "fade-up 0.5s ease both" }}
          >
            <h1
              style={{
                fontFamily: "'Fraunces', serif",
          ...
          >
            ...
            />
            <span
              style={{ fontWeight: 700, fontSize: 14, color: sc.text, flex: 1 }}
            >
              {sc.label}
            </span>
            ...
            >
              ...
              <div
                style={{
                  ...
                  letterSpacing: "-1px",
                  color: "var(--text)",
                  textShadow: "3px 4px 0 var(--stamp)",
                  lineHeight: 1,
                }}
              >
                {countdown}
          ...
          >
            <h2
              style={{
                ...
                letterSpacing: "-0.3px",
                color: "var(--text)",
                textShadow: "1px 2px 0 var(--stamp)",
              }}
            >
            ...
            >
              This will <strong>permanently destroy</strong> the document from
            ...
            <div style={{ display: "flex", gap: 10 }}>
              ...
              <button
                ...
                style={{
                  flex: 1,
                  padding: "12px 16px",
                  background: isDeleting ? "var(--surface2)" : "var(--red-dim)",
                  border: "2px solid var(--red)",
                  borderRadius: 8,
                  fontWeight: 700,
                  fontSize: 13,
